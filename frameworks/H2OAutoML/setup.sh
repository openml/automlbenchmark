...
if [[ "$VERSION" = "yates" || -z "$VERSION" ]]; then
    echo "installing H2O-3 yates"
    PIP install --no-cache-dir -U http://h2o-release.s3.amazonaws.com/h2o/rel-yates/1/Python/h2o-3.24.0.1-py2.py3-none-any.whl
elif [[ "$VERSION" = "xu" || -z "$VERSION" ]]; then
