...
def run(dataset: Dataset, config: TaskConfig):
    ...
    gcp_info = {  # GCP configuration info. You should only change: GOOGLE_APPLICATION_CREDENTIALS to location of GCP key file.
        'PROJECT_ID': "automl-264518",
        'BUCKET_NAME': "tabulardata",
        'COMPUTE_REGION': "us-central1",
        'GOOGLE_APPLICATION_CREDENTIALS': '../automlbenchmark/frameworks/GoogleAutoMLTables_benchmark/AutoML-56559d3cc4f3.json',
    }
    ...
    dataset_name_gcp_suffix = '_amlb_v1_' + str(config.max_runtime_seconds) + '_f' + str(config.fold)
