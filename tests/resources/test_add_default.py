...
def test_module_default_uses_framework_name(name):
    ...
    add_default_module(framework, dummy_config)
...
def test_module_is_not_replaced_if_defined():
    ...
    add_default_module(framework, config=dummy_config)
...
def test_setup_args_set_to_version_if_undefined():
    ...
    add_default_setup_args(f_my_version)
    add_default_setup_args(f_my_other_version)
...
def test_setup_cmd_set_to_none_if_undefined(simple_resource):
    framework = Namespace()
    add_default_setup_cmd(framework, simple_resource)
...
def test_image_uses_default_author(simple_resource):
    ...
    add_default_image(framework, simple_resource.config)
