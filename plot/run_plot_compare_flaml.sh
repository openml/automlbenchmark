...
#Plot learning curve 
python plot_learning_curve_flaml.py -file ../results/log/  -time 3600 -m flaml lightautoml  -d bng_pbc -l None
python plot_learning_curve_flaml.py -file ../results/log/  -time 3600 -m flaml lightautoml  -l lower_left -d Albert
python plot_learning_curve_flaml.py -file ../results/log/  -time 3600 -m flaml lightautoml  -l None -d Covertype

# plot radar
python plot_radar_flaml.py -file ../results/results_avg.csv  -f  flaml lightautoml -e all  -d all_reg
python plot_radar_flaml.py -file ../results/results_avg.csv  -f  flaml lightautoml -e all  -d all_bin
python plot_radar_flaml.py -file ../results/results_avg.csv  -f  flaml lightautoml -e all  -d all_multi

# plot winners
python plot_res_flaml.py -file ../results/results_avg.csv  -f  flaml lightautoml -time 60 -e all  -d all
python plot_res_flaml.py -file ../results/results_avg.csv  -f  flaml lightautoml -time 600 -e all  -d all
python plot_res_flaml.py -file ../results/results_avg.csv  -f flaml lightautoml   -time 3600 -e all  -d all
